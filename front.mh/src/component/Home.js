    ...
    return (
        <div>
            <div className='containerVideo'>
                <video loop="true" muted="true" autoplay="true" className='videoBackground'>
                    <source src="/Videos/video.mp4" type="video/mp4"/>
                </video>
            </div>
            <div className='Home-Content1 wrap-90'>
                <div className='text-slate-300'>
                    <p className='text-6xl text-amber-400 uppercase tracking-widest mb-2 typo-lol'>MapHeat</p>
                    <div className='flex items-center'>
                        <div className='line1'></div>
                        <p className='text-3xl uppercase font-extralight tracking-widest my-2'>Redécouvrez votre partie</p>
                    </div>
                    <p className='text-xl font-extralight'>Une analyse avancé de vos parties</p>
                    <p className='text-xl font-extralight'>Grace à notre client disponible pour tous</p>
