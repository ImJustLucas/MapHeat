...
class MatchTimelineRepository extends ServiceEntityRepository
{
    ...
    public function save(MatchTimeline $entity, bool $flush = false): void
    {
    ...
    public function addMatchTimeline($data, $matchID): void
    {
        $newMatch = new MatchTimeline();
        $newMatch->setMatchId($matchID);
        $newMatch->setData($data);

        $this->save($newMatch, true);
    }
